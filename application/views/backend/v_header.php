            ...
            <nav class="navbar bg-light navbar-light">
                ...
                <div class="navbar-nav w-100">
                    ...
                    <div class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu bg-transparent border-0">
                            <a href="<?= base_url('transaksi/masuk') ?>" class="dropdown-item">Pemesanan Masuk</a>
                            <a href="<?= base_url('transaksi/proses') ?>" class="dropdown-item">Pemesanan Proses</a>
                            <a href="<?= base_url('transaksi/selesai') ?>" class="dropdown-item">Pemesanan Selesai</a>
                            <a href="<?= base_url('transaksi/batal') ?>" class="dropdown-item">Pemesanan Batal</a>
                        </div>
                    </div>
                </div>
            </nav>
