...
<head>
  ...
  <link rel="stylesheet" href="<?= base_url() ?>royal-master/css/font-awesome.min.css">
  <link rel="stylesheet" href="<?= base_url() ?>royal-master/vendors/owl-carousel/owl.carousel.min.css">
  <link rel="stylesheet" href="<?= base_url() ?>royal-master/vendors/bootstrap-datepicker/bootstrap-datetimepicker.min.css">
  <link rel="stylesheet" href="<?= base_url() ?>royal-master/vendors/nice-select/css/nice-select.css">
  <link rel="stylesheet" href="<?= base_url() ?>royal-master/vendors/owl-carousel/owl.carousel.min.css">
  <!-- main css -->
